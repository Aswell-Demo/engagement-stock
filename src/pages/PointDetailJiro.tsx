// src/pages/PointDetailJiro.tsx
const PointDetailJiro = () => {
  return (
          ...
          <table className="w-full table-auto border">
            ...
            <tbody>
              <tr className="text-center border-t">
                ...
                <td className="p-2">サンプル 次郎</td>
                <td className="p-2">8,000pt</td>
                <td className="p-2">2,000pt</td>
                <td className="p-2">3,000pt</td>
                <td className="p-2">13,000pt</td>
                <td className="p-2">2026/04/15</td>
                <td className="p-2">2029/10/01</td>
                <td className="p-2 text-yellow-600 font-semibold">一部有効</td>
              </tr>
            </tbody>
          </table>
        </div>
        ...
        <div className="mb-10">
          ...
          <table className="w-full table-auto border mb-4">
            ...
            <tbody>
              <tr className="text-center border-t">
                <td className="p-2">2026/04/15</td>
                <td className="p-2">業績評価A</td>
                <td className="p-2">13,000pt</td>
                <td className="p-2">管理者C</td>
                <td className="p-2">2029/09/30</td>
                <td className="p-2">年度評価に基づく付与</td>
              </tr>
            </tbody>
          </table>
        </div>
          ...
          <table className="w-full table-auto border">
            ...
            <tbody>
              <tr className="text-center border-t">
                <td className="p-2">2029/10/01</td>
                <td className="p-2">2,000pt</td>
                <td className="p-2">申請中</td>
                <td className="p-2"></td>
                <td className="p-2">換金申請</td>
              </tr>
              <tr className="text-center border-t">
                <td className="p-2">2029/10/01</td>
                <td className="p-2">3,000pt</td>
                <td className="p-2">承認済み</td>
                <td className="p-2">2029/10/05</td>
                <td className="p-2">換金</td>
              </tr>
            </tbody>
          </table>
...
export default PointDetailJiro;
